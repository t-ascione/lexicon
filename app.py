...
def get_db_connection():
    """Establish a connection to the database that works locally and in the cloud."""
    # Find exactly where app.py is sitting on the server
    script_dir = os.path.dirname(os.path.abspath(__file__))
    db_path = os.path.join(script_dir, "lexicon_app.db")
    
    # Standard, robust connection line for cloud server hosting
